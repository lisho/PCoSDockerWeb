...
<div class="primer_container"  style="margin-top:40px">
<div class="row">
    <div class="text-center" id="titulo">
        <h2>Proyecto de apoyo para el acceso a la administración 
        electrónica y reducción de la brecha digital</h2>
...
<div class="container text-center" id="solicitante">
    <br>
    <h4> D./Dña. <b>'.$nombre.'&nbsp;'.$apellido1.'&nbsp;'.$apellido2.'</b>, con DNI <b>'.$dni'</b></h4>
    <br><br><br>
    <p>ha quedado inscrito correctamente en la actividad:</p>
    ...
    <div class="explicacion">
        <p class="text-justify justificado">
            ...
            día 22 de febrero de 2021 para concertar cita previa para el desarrollo de la actividad. Para ello se utilizará la
