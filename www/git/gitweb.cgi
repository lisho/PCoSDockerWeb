...
my $projectroot = '/home/puertasdigitales/domains/pcos.puertasdigitales.es/public_html/git';
...
my $snapshots_url = 'http://pcos.puertasdigitales.es/git';
my $git_base_url = 'http://pcos.puertasdigitales.es/git';
