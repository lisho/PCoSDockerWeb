...
<?php
if ($_POST['buscador']){
    // Mediante AJAX realizamos la asignacion del valor del formulario con nombre palabra. por tanto la siguiente linea no comewntada sera borrada una vez AJAX funcione
    //esto es asi, pues el js debiera encargarse del metodo POST, para asegurarnos de que la pagina no hace una recarga innecesaria.
