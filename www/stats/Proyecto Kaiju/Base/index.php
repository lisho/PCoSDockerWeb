...
//  <script type="text/javascript"> $('#portfolioModalbus').modal('hide');</script>
//    }else{
//   <script type="text/javascript"> $('#portfolioModalbus').modal('show');</script>
//    }
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a href="#opciones" data-toggle="modal" class="nav-link py-3 px-0 px-lg-3 rounded" type="button">
                        
                        <?php echo $lang['Opciones']; ?>
                </a></li>
                    </ul>
                </div>
            </div>
...
El problema reside en el hecho de que el equivalente en php es una comprobacion con typeof. la variable buscar siempre es algo. pues esta inicializada y declarada, siendo
esta el valor de post. Por tanto: ¿Cual es el valor de post?. Debiera ser undefined hasta que se realice una busqueda... ¿No debiera entonces ser $buscar undefined?
Por lo visto no, dado que la comprobacion no lo acepta, o eso, o considera que tenga o no un valor especificado en ambos casos el valor es undefined. Tras este razonamiento
concluimos que el valor no puede ser undefined... ¿Cual es entonces? Por lo que parece es undefined dado que nunca tiene un valor especificado fijo, sino un valor No
definido que varia con cada busqueda... por tanto el valor siempre es el mismo y nunca cambia... ¿como entonces registrar, comprobar y actuar en consecuencia de un
cambio que no existe? por lo visto la manera de hacer esto es con AJAX... toca estudiar.-->
...
?>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesBus[$bus][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                            </div>
                                                          </div>
                                                      </div>
                ...
                <div class="col-md-1"></div>
                    <div class="col-md-10">
                        ...
                        <ul>
                            ...
                            <li><p><?php echo $lang['Telefono']; ?>: 666234569</p></li>
                            <li><p><?php echo $lang['Direccion']; ?>: C/direccion 1</p></li>
                        </ul>
                        <br>
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div id="" class="col-sm-12">
										<?php
											...
											{
                                                echo "<div class='col-md-6 col-lg-4 mb-5'><button class='btn' style='background-color: #779ECB' data-toggle='modal' data-target='#ModalA".$a."'><img class='img-fluid' src='".$listaTramitesSACYL[$a][7]."' alt='Logo Trámite SACYL' />";
                                                echo "<div class='portfolio-item mx-auto' >
                                                    ".$listaTramitesSACYL[$a][2]."
                                                    </div>
												</button>";
                                                echo "</div>";                                      
											}
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesSACYL2[$a][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesECYL2[$b][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesDGT2[$c][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>                                                                
                                                                </br>
                                                              <div class='row justify-content-center'>
                                                                <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                            </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesPolicia2[$d][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesAyto2[$e][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesInss2[$f][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                    ...
                    <div class="modal-body text-center">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <!-- Portfolio Modal - Title-->
                                    <h3 class="portfolio-modal-title text-secondary text-uppercase mb-0" id="ModalAEAT">AEAT</h3>
                                    <!-- Icon Divider-->
                                    <div class="divider-custom">
                                        <div class="divider-custom-line"></div>
                                        <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesAEAT2[$g][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesSEPE2[$h][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesJusticia2[$i][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
                                                    ...
                                                    echo "<div class='modal-dialog modal-dialog-centered' role='document'>";
                                                        echo "<div class='modal-content'>";
                                                            ...
                                                            <br>
                                                                ...
                                                                <h5>URL:</h5>
                                                                <p><a href=".$listaTramitesJCyL2[$j][3]." target='_blank'><button type='button' class='btn btn-secondary'>".$lang['Iniciar Tramite']."</button></a></p></br>
                                                                </br>
                                                                <div class='row justify-content-center'>
                                                                  <button type='button' class='btn btn-primary' data-dismiss='modal'>".$lang['Cerrar']."</button></p>
                                                              </div>  
    ...
    <script>
        ...
        var markerubicacion = new mapboxgl.Marker()
            .setLngLat([-5.571874, 42.598129])
            .setPopup(new mapboxgl.Popup().setHTML("<h1>Ubicacion 1</h1>"))
            .addTo(map);
        var markerubicacion2 = new mapboxgl.Marker()
            .setLngLat([-5.5814238183366776, 42.602125829685775])
            .setPopup(new mapboxgl.Popup().setHTML("<h1>Ubicacion 2</h1>"))
            .addTo(map);
    </script>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?php echo $lang['Opciones']; ?></h3>
    ...
    <div id="guias" class="modal fade">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul>
                        <li><h4><a href="descargas/GMAIL PARA MOVIL.pdf" download="GMAIL PARA MOVIL.pdf">Gmail para móvil en PDF</a></h4></li>
                    </ul>
                </div>
            </div>
        </div>
